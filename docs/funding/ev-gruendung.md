...
Europe). Der e.V. läuft **neben** der bestehenden GbR: die GbR bleibt für
kommerzielle Tech-Lead-Dienstleistungen, der e.V. trägt die gemeinnützige
Kulturarbeit.

> ⚠️ **Kein Rechts- oder Steuerrat.** Dieser Leitfaden ist eine Arbeitsgrundlage.
> Die Satzung und die Gemeinnützigkeit müssen von einem **Notar** und einem
> **Steuerberater** bzw. dem **Finanzamt** geprüft werden, bevor ihr sie
> einreicht. Alle Beträge sind ca.-Werte (Stand prüfen).
...
Die **GbR bleibt bestehen** für bezahlte Produktionsaufträge. Wichtig:
Geschäfte zwischen GbR und e.V. müssen **marktüblich** und dokumentiert sein
(siehe §55 AO / Abschnitt 8), sonst gefährdet ihr die Gemeinnützigkeit.

---

## 1. Voraussetzungen auf einen Blick

| Punkt | Anforderung |
|---|---|
| Gründungsmitglieder | **mindestens 7** (natürliche oder juristische Personen) für die Eintragung (§ 56 BGB) |
...
- **Zweck** des Vereins.
- Eintritt/Austritt von Mitgliedern; Beiträge (ob und welche).
- **Organe**: Mitgliederversammlung, Vorstand.
- Einberufung, Beschlussfähigkeit und Protokollierung der Mitgliederversammlung.
...
- **Gemeinnütziger Zweck** benannt (Förderung von Kunst und Kultur, ggf. Bildung).
- **Selbstlosigkeit**: „Der Verein ist selbstlos tätig; er verfolgt nicht in erster
  Linie eigenwirtschaftliche Zwecke." (§ 55 AO)
- **Ausschließlichkeit & Unmittelbarkeit** (§§ 56, 57 AO).
- **Mittelverwendung**: Mittel nur für satzungsmäßige Zwecke; Mitglieder erhalten
  keine Zuwendungen aus Vereinsmitteln.
- **Kein Begünstigungsverbot verletzen**: keine unverhältnismäßig hohen Vergütungen,
...
|---|---|---|
| **Ideeller Bereich** | Beiträge, Spenden, öffentliche Zuschüsse | steuerfrei |
| **Vermögensverwaltung** | Zinsen, Vermietung | steuerfrei |
| **Zweckbetrieb** | satzungsgemäße Veranstaltung (Ausstellung, Konferenz), die den Zweck verwirklicht | steuerbegünstigt |
| **Wirtschaftlicher Geschäftsbetrieb** | aktive Werbung/Sponsoring mit Gegenleistung, Verkauf | steuerpflichtig ab Freigrenze |

Wichtige Hebel:
- **Tezcon als Zweckbetrieb** gestalten (Bildung/Kultur, kein Gewinnstreben) →
  Tickets bleiben begünstigt. Mit Steuerberater sauber abgrenzen.
- **Sponsoring**: bloße **Duldung** von Logo-Nennung (ohne aktive Werbeleistung
  des Vereins) ist eher steuerfrei; **aktive Werbung** ist wirtschaftlicher
  Geschäftsbetrieb.
- **Freigrenze**: Einnahmen des wirtschaftlichen Geschäftsbetriebs bis
  **ca. 45.000 € brutto/Jahr** bleiben körperschaft-/gewerbesteuerfrei (§ 64 Abs. 3 AO).
...
- Markenrechtliche Abgrenzung zur GbR/Marke „ratata" mitdenken.
...
Da **dieselben Personen** GbR und e.V. steuern, ist das der heikelste Punkt:
- Leistungen der GbR an den e.V. (z.B. bezahlte Tech-/Minting-Produktion für Tezcon)
...
> „Zweck des Vereins ist die Förderung von Kunst und Kultur, insbesondere der
> digitalen und zeitgenössischen Kunst. Der Satzungszweck wird verwirklicht
> insbesondere durch die Konzeption und Durchführung von Ausstellungen,
> Veranstaltungen, Vermittlungs- und Bildungsformaten sowie die Förderung von
> Künstlerinnen und Künstlern und den Aufbau einer offenen Community."

(Wortlaut mit Steuerberater/Finanzamt final abstimmen.)
...
| Posten | ca. |
|---|---|
| Notar (Beglaubigung) | 30–100 € |
| Amtsgericht (Eintragung) | 50–75 € |
| Satzung durch Steuerberater (optional) | einige 100 € |
| **Setup gesamt** | **~100–200 €** (ohne Berater) |
| **Dauer** | **~2–4 Monate** (Gründungsversammlung schnell; Finanzamt + Amtsgericht je einige Wochen) |

→ Deshalb **jetzt starten**, damit der e.V. für die Tezcon-2027-Anträge steht.

---

## 8. Checkliste

- [ ] Zweck & Konzept festgelegt (Kunst/Kultur, ggf. Bildung)
- [ ] Name geprüft (Vereinsregister, Marke)
- [ ] 7 Gründungsmitglieder gewonnen
- [ ] Satzung entworfen (inkl. Gemeinnützigkeits-Klauseln § 60 AO)
- [ ] Satzung vom Steuerberater/Finanzamt vorgeprüft (§ 60a AO)
- [ ] Gründungsversammlung terminiert
- [ ] Gründungsprotokoll + Satzung von allen unterschrieben
- [ ] Vorstand gewählt, Vertretungsregeln festgelegt
- [ ] Notartermin (Beglaubigung der Anmeldung)
- [ ] Anmeldung beim Amtsgericht Frankfurt (Vereinsregister)
- [ ] Feststellung Gemeinnützigkeit beim Finanzamt (§ 60a)
- [ ] Vereinskonto eröffnet
- [ ] GbR↔e.V.-Verträge/Trennung dokumentiert
- [ ] Buchführung & Ablage aufgesetzt
